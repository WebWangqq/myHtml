    ...
    return e.prototype = {
            ...
            function n(e) {
                ...
                e["int_" + e.id] = setInterval(function() {
                    ...
                    if (i += n, Math.abs(n) > .1);
                        ...
                        var d = 2.4 * Math.round(i / 2.4);
                        i = d,
                        t()
                    }
                    i > 0 && (i = 0, t());
                    var o = 2.4 * -(e.dataset.len - 1);
                    if (o > i && (i = o, t()), r) {
                        var c = Math.abs(i) / 2.4;
                        s(e, c),
                        clearInterval(e["int_" + e.id])
                    }
                    e["pos_" + e.id] = i,
        ...
        setGearTooth: function(e) {
            ...
            if (n > s && (n = s), i[t.index].setAttribute("data-len", r), r > 0) {
                ...
                if (i[t.index].innerHTML = l, i[t.index].style["-webkit-transform"] = "translate3d(0," + 2.4 * -n + "em,0)", i[t.index].setAttribute("top", 2.4 * -n + "em"), i[t.index].setAttribute("val", n), t.index++, t.index > 2) return void(t.index = 0);
                t.setGearTooth(d)
